package com.crescendo.ats.config;

import com.crescendo.ats.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.crescendo.ats.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.crescendo.ats.repository.search")
