...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .post("/api/activitys")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "priority":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "status":"SAMPLE_TEXT", "comments":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
